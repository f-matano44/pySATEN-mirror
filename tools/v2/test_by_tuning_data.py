...
def _main():
    ...
    wav_files = [
        "wav_and_lab/zundamon/ITA_emotion_normal_synchronized_wav/emoNormal",
        "wav_and_lab/tohoku_itako/ITA_emotion_normal_synchronized_wav/emoNormal",
    ]

    lab_files = [
        "wav_and_lab/zundamon/ITA_emotion_normal_label/emoNormal",
        "wav_and_lab/tohoku_itako/ITA_emotion_normal_label/emoNormal",
    ]
